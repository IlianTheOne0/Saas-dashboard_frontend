...
function SidebarContent({ data })
{
	...
	{
		if (!name) { return null; }
		return `https://raw.githubusercontent.com/IlianTheOne0/Saas-dashboard_frontend/refs/heads/developer/src/features/dashboard/pages/Home/tabs/Dashboard/assets/images/${name}`;
	};
