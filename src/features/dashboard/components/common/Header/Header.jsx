...
function Header({ tabsData, asideData, activeTab, handleNavigation, handleToggleTheme, handleLogout, getIconUrl, theme })
{
	...
	return (
		<>
			<DesktopHeader tabsData={tabsData} handleNavigation={handleNavigation} isLoading={isLoading} userData={userData} />
