...
function UserProvider({ children })
{
	...
	const value = useMemo
	(
        () => ({ accessToken, isLoading, saveAccessToken, removeAccessToken, getPersonalData, getAllContacts, starContact }),
        [accessToken, isLoading, saveAccessToken, removeAccessToken, getPersonalData, getAllContacts]
    );
